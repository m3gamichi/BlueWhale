...
try:
    ...
    sites = {
        ...
        "Telegram": {
            ...
            "verification": "username",
            "except": [
                f"if you have telegram, you can contact @{username} right away.",
                f"resolve?domain={username}",
                f"telegram: contact @{username}",
            ],
        },
        "TikTok": {
                    ...
                    if "status" in verification:
                        ...
                        if page_except:
                            for page_content_except in page_except:
                                if (
                                    page_content_except.lower() in page_content
                                    or page_content_except.lower() in page_text
                                    or page_content_except.lower() in page_title
                                ):
                                    found = False
